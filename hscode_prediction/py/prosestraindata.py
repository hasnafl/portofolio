...
def train():
    ...
    import pickle
    model_path="/home/py/goodmodel.pkl"
    transformer_path="/home/py/goodtransformer.pkl"
...
def transfer2(filename):
    ...
    # close the socket
    s.close()
filename = "/home/py/goodmodel.pkl"
filename2 = "transformerhscode_exmp.pkl"
transfer(filename)
transfer2(filename2)
