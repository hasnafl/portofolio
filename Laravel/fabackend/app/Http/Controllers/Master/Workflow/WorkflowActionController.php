...
use App\Services\Master\Workflow\WorkflowActionService;
use App\Repositories\Master\Workflow\WorkflowActionRepository;
...
{
    public function __construct(Request $request, WorkflowActionService $service, WorkflowActionRepository $repository)
    {
    ...
    public function store()
    {
        ...
        return response()->json([
            'success' => true,
            'message' => 'Workflow Action '.$data->id.' created.',
    ...
    public function update($code)
    {
        ...
        if ($code != $this->request->id) {
            throw new \Exception('Workflow Action cannot be changed.');
        }
        ...
        return response()->json([
            'success' => true,
            'message' => 'Workflow Action '.$code.' updated.',
            'data' => $this->repository->show($code)
        ]);
    }
    ...
    public function delete($code)
    {
        ...
        return response()->json([
            'success' => true,
            'message' => 'Workflow Action  '.$code.' deleted.',
        ]);
    }
    ...
    public function destroy($code)
    {
        ...
        return response()->json([
            'success' => true,
            'message' => 'Workflow Action deleted.',
        ]);
    }
    ...
    public function changeActive($code)
    {
       ...
       return response()->json([
            'success' => true,
            'message' => 'Workflow Action ' ."$code". " " . $message,
            'data' => $this->repository->show($code)
        ]);
