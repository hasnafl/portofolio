            ...
            <div class="card-inner">
                <div>
                    <div class="card-title-group align-start gx-3 mb-3">
                        ...
                        <div class="card-tools">
                            <nuxt-link to="/klasifikasipelanggan/create" class="btn btn-primary btn-dim"><em class="icon ni ni-plus"></em><span>Add New Data</span></nuxt-link>
                        </div>
                    </div>
                ...
                <div>
                    <div class="card-title-group align-start gx-3 mb-3 mt-4">
                        <div class="card-title">
                            <h6 class="title">Latest Costumer Classification Created</h6>
                        </div>
                        <div class="card-tools">
                            <div class="drodown">
                                <a
                        ...
                        <table class="table table-tranx mt-4 is-compact">
                            <thead>
                                <tr class="tb-tnx-head">
                                    ...
                                    <th>
                                        <span class="d-md-inline-block d-none">Klasifikasi Pelanggan</span>
                                    </th>
                                    <th>
                                        <span class="d-md-inline-block d-none">Akun Akrual Piutang</span>
                                    </th>
                                    <th>
                                        <span class="d-md-inline-block d-none">Akun Piutang</span>
                                    </th>
                                    <th>
                                        <span class="d-md-inline-block d-none">Akun Uang Muka</span>
                                    </th>
                                    <th>
                            ...
                            <tbody>
                                <tr class="tb-tnx-item" v-for="(custclass, index) in data.data" :key="index">
                                    <td>
                                        <span class="d-md-inline-block d-none">{{ index + data.from }}</span>
                                        <div class="d-md-none d-inline-block">
                                            <strong class="text-primary">{{ custclass.id }}</strong>
                                            <br>
                                            <span>{{ custclass.id }} / {{ custclass.classification_code }}</span>
                                            <br>
                                            <Label :active="custclass.is_active" />
                                        </div>
                                    </td>
                                    <td>
                                        <span class="d-md-inline-block d-none">
                                            <strong class="text-primary">{{ custclass.classification_code }}</strong> -
                                            {{ custclass.classification_name}}
                                        </span>
                                    </td>
                                    <td>
                                        <span class="d-md-inline-block d-none">{{ custclass.account_akrual_piutang }}</span>
                                    </td>
                                    <td>
                                        <span class="d-md-inline-block d-none">{{ custclass.account_piutang }}</span>
                                    </td>
                                    <td>
                                        <span class="d-md-inline-block d-none">{{ custclass.account_downpayment }}</span>
                                    </td>
                                    <td>
                                        <span class="d-md-inline-block d-none">
                                            <Label :active="custclass.is_active" />
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-xs">
                                                <ul class="link-list-plain">
                                                    <li><nuxt-link :to="`/klasifikasipelanggan/detail/${custclass.id}`">View</nuxt-link></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </td>
...
export default {
    ...
    methods: {
        ...
        fetch (resetPage = false) {
            ...
            this.$axios.$post('/api/v1/klasifikasipelanggan/p', filter)
                .then((response) => {
        ...
        downloadTemplate() {
        this.$axios
            .$get("/api/v1/klasifikasipelanggan/template", { responseType: "blob" })
            .then((response) => {
            const blob = new Blob([response]);
            saveAs(blob, "customerclass_template.xlsx");
            });
        },
        exportData() {
        this.$axios
            .$get("/api/v1/klasifikasipelanggan/export", { responseType: "blob" })
            .then((response) => {
            const blob = new Blob([response]);
            saveAs(blob, "customerclass_export.xlsx");
            });
        },
        importData() {
        ...
        this.$axios
            .$post(`/api/v1/klasifikasipelanggan/import`, formData, headers)
            .then((data) => {
