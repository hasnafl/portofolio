                ...
                <form @submit.prevent="update" class="gy-3">
                        ...
                        <div class="col-lg-10">
                            <div class="form-group">
                                <div class="form-control-wrap">
                                    <input type="text" class="form-control" v-model="data.entitycode" disabled>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row g-3 align-center">
                        ...
                        <div class="col-lg-10">
                            <div class="form-group">
                                <div class="form-control-wrap">
                                    <input type="text" class="form-control" v-model="data.entityaddress" :disabled="!edit">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row g-3 align-center">
                        ...
                        <div class="col-lg-10">
                            <div class="form-group">
                                <div class="form-control-wrap">
                                    <input type="text" class="form-control" v-model="data.entityphone" :disabled="!edit">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row g-3 align-center">
                        ...
                        <div class="col-lg-10">
                            <div class="form-group">
                                <div class="form-control-wrap">
                                    <input type="text" class="form-control" v-model="data.entitycontactperson" :disabled="!edit">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div v-if="!edit" class="mt-5">
                    ...
                    <div class="g-3 d-flex justify-content-between">
                        ...
                        <div>
                            ...
                            <nuxt-link to="/entity/create" class="btn btn-primary">Add New Data</nuxt-link>
                        </div>
                    </div>
                </div>
            </div>
...
export default {
    ...
    methods: {
        parse (data) {
            this.data = data.data;
            if (this.data.entity) {
            this.entities.push(this.data.entity);
      }
        },
        fetch () {
            this.$axios.$get(`/api/v1/entity/${this.$route.params.id}`, { params: { d: new Date().getTime() } })
                .then((data) => {
                    this.parse(data);
                });
        },
        update () {
            ...
            this.$axios.$patch(`/api/v1/entity/${this.data.id}`, data)
                .then((data) => {
                    this.parse(data);
                    this.edit = false;
                });
        ...
        changeActive() {
            this.$axios
                .$post(
                `/api/v1/entity/${this.data.id}/change_active`,
                {
                    d: new Date().getTime(),
                }
                )
            ...
            this.$axios
                .$post(
                `/api/v1/entity/${this.data.id}/change_delete`,
                {
                    d: new Date().getTime(),
                }
                )
