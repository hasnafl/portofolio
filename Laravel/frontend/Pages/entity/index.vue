            ...
            <div class="card-inner">
                <div>
                    <div class="card-title-group align-start gx-3 mb-3">
                        ...
                        <div class="card-tools">
                            <nuxt-link to="/entity/create" class="btn btn-primary btn-dim"><em class="icon ni ni-plus"></em><span>Add New Data</span></nuxt-link>
                        </div>
                    </div>
                ...
                <div>
                    <div class="card-title-group align-start gx-3 mb-3 mt-4">
                        <div class="card-title">
                            <h6 class="title">Latest Entity Created</h6>
                        </div>
                        <div class="card-tools">
                            <div class="drodown">
                                <a
                        ...
                        <table class="table table-tranx mt-4 is-compact">
                            <thead>
                                <tr class="tb-tnx-head">
                                    ...
                                    <th>
                                        <span class="d-md-inline-block d-none">Entity Code</span>
                                    </th>
                                    <th>
                                        <span class="d-md-inline-block d-none">Entity Name</span>
                                    </th>
                                    <th>
                                        <span class="d-lg-inline-block d-none">Address</span>
                                    </th>
                                    <th>
                                        <span class="d-lg-inline-block d-none">Phone</span>
                                    </th>
                                    <th>
                                        <span class="d-lg-inline-block d-none">Contact Person</span>
                                    </th>
                                    <th>
                                        <span class="d-lg-inline-block d-none">Status</span>
                                    </th>
                                    <th>
                                        <span>&nbsp;</span>
                                    </th>
                            ...
                            <tbody>
                                <tr class="tb-tnx-item" v-for="(entity, index) in data.data" :key="index">
                                    <td>
                                        <span class="d-md-inline-block d-none">{{ index + data.from }}</span>
                                        <div class="d-md-none d-inline-block">
                                            <strong class="text-primary">{{ entity.entitycode }}</strong>
                                            <br>
                                            <span>{{ entity.entityname }} / {{ entity.entityaddress }} ({{ entity.entityphone }})</span>
                                            <br>
                                            <Label :active="entity.is_active" />
                                        </div>
                                    </td>
                                    <td>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-xs">
                                                <ul class="link-list-plain">
                                                    <li><nuxt-link :to="`/entity/detail/${entity.id}`">View</nuxt-link></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </td>
...
export default {
    ...
    methods: {
        ...
        fetch (resetPage = false) {
            ...
            this.$axios.$post('/api/v1/entity/p', filter)
                .then((response) => {
        ...
        downloadTemplate() {
        this.$axios
            .$get("/api/v1/entity/template", { responseType: "blob" })
            .then((response) => {
            const blob = new Blob([response]);
            saveAs(blob, "entity_template.xlsx");
            });
        },
        exportData() {
        this.$axios
            .$get("/api/v1/entity/export", { responseType: "blob" })
            .then((response) => {
            const blob = new Blob([response]);
            saveAs(blob, "entity_export.xlsx");
            });
        },
        importData() {
        ...
        this.$axios
            .$post(`/api/v1/entity/import`, formData, headers)
            .then((data) => {
