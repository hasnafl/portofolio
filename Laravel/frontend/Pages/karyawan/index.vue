            ...
            <div class="card-inner">
                <div>
                    <div class="card-title-group align-start gx-3 mb-3">
                        ...
                        <div class="card-tools">
                            <nuxt-link to="/karyawan/create" class="btn btn-primary btn-dim"><em class="icon ni ni-plus"></em><span>Add New Data</span></nuxt-link>
                        </div>
                    </div>
                ...
                <div>
                    <div class="card-title-group align-start gx-3 mb-3 mt-4">
                        <div class="card-title">
                            <h6 class="title">Latest Employee Created</h6>
                        </div>
                        <div class="card-tools">
                            <div class="drodown">
                                <a
                        ...
                        <table class="table table-tranx mt-4 is-compact">
                            <thead>
                                <tr class="tb-tnx-head">
                                    ...
                                    <th>
                                        <span class="d-md-inline-block d-none">Employee</span>
                                    </th>
                                    <th>
                                        <span class="d-md-inline-block d-none">Address</span>
                                    </th>
                                    <th>
                                        <span class="d-md-inline-block d-none">Contact</span>
                                    </th>
                                    <th>
                                        <span class="d-md-inline-block d-none">Department</span>
                                    </th>
                                    <th>
                                        <span class="d-md-inline-block d-none">Office/Location</span>
                                    </th>
                                    <th>
                                        <span class="d-md-inline-block d-none">Branch</span>
                                    </th>
                                    <th>
                            ...
                            <tbody>
                                <tr class="tb-tnx-item" v-for="(employee, index) in data.data" :key="index">
                                    <td>
                                        <span class="d-md-inline-block d-none">{{ index + data.from }}</span>
                                        <div class="d-md-none d-inline-block">
                                            <strong class="text-primary">{{ employee.idk_kode_karyawan }}</strong>
                                            <br>
                                            <span>{{ employee.idk_kode_karyawan }} / {{ employee.idk_nama_karyawan }} ({{ employee.idk_telpon1_karyawan }})</span>
                                            <br>
                                            <Label :active="employee.is_active" />
                                        </div>
                                    </td>
                                    <td>
                                        <span class="d-md-inline-block d-none">
                                            <strong class="text-primary">{{ employee.idk_kode_karyawan }}</strong> -
                                            {{ employee.idk_nama_karyawan}}
                                        </span>
                                    </td>
                                    <td>
                                        <span class="d-md-inline-block d-none">{{ employee.idk_alamat }}</span>
                                    </td>
                                    <td>
                                        <span class="d-md-inline-block d-none">{{ employee.idk_telpon1_karyawan }}</span>
                                    </td>
                                    <td>
                                        <span class="d-md-inline-block d-none">{{ employee.idk_departement }}</span>
                                    </td>
                                    <td>
                                        <span class="d-md-inline-block d-none">{{ employee.idk_kantor_lokasi }}</span>
                                    </td>
                                    <td>
                                        <span class="d-md-inline-block d-none">{{ employee.idk_cabang }}</span>
                                    </td>
                                    <td>
                                        <span class="d-md-inline-block d-none">
                                            <Label :active="employee.is_active" />
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-xs">
                                                <ul class="link-list-plain">
                                                    <li><nuxt-link :to="`/karyawan/detail/${employee.idk_kode_karyawan}`">View</nuxt-link></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </td>
...
export default {
    ...
    methods: {
        ...
        fetch (resetPage = false) {
            ...
            this.$axios.$post('/api/v1/karyawan/p', filter)
                .then((response) => {
        ...
        downloadTemplate() {
        this.$axios
            .$get("/api/v1/karyawan/template", { responseType: "blob" })
            .then((response) => {
        ...
        exportData() {
        this.$axios
            .$get("/api/v1/karyawan/export", { responseType: "blob" })
            .then((response) => {
            const blob = new Blob([response]);
            saveAs(blob, "employee_export.xlsx");
            });
        },
        importData() {
        ...
        this.$axios
            .$post(`/api/v1/karyawan/import`, formData, headers)
            .then((data) => {
