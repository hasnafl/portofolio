            ...
            <div class="card-inner">
                <div>
                    <div class="card-title-group align-start gx-3 mb-3">
                        ...
                        <div class="card-tools">
                            <nuxt-link to="/datapelanggan/create" class="btn btn-primary btn-dim"><em class="icon ni ni-plus"></em><span>Add New Data</span></nuxt-link>
                        </div>
                    </div>
                ...
                <div>
                    <div class="card-title-group align-start gx-3 mb-3 mt-4">
                        <div class="card-title">
                            <h6 class="title">Latest Costumers Created</h6>
                        </div>
                        <div class="card-tools">
                            <div class="drodown">
                                <a
                        ...
                        <table class="table table-tranx mt-4 is-compact">
                            <thead>
                                <tr class="tb-tnx-head">
                                    ...
                                    <th>
                                        <span class="d-md-inline-block d-none">Pelanggan</span>
                                    </th>
                                    <th>
                                        <span class="d-md-inline-block d-none">Alamat Utama</span>
                                    </th>
                                    <th>
                                        <span class="d-md-inline-block d-none">Penanggung Jawab</span>
                                    </th>
                                    <th>
                                        <span class="d-md-inline-block d-none">Klasifikasi</span>
                                    </th>
                                    <th>
                                        <span class="d-md-inline-block d-none">Cabang</span>
                                    </th>
                                    <th>
                            ...
                            <tbody>
                                <tr class="tb-tnx-item" v-for="(customer, index) in data.data" :key="index">
                                    <td>
                                        <span class="d-md-inline-block d-none">{{ index + data.from }}</span>
                                        <div class="d-md-none d-inline-block">
                                            <strong class="text-primary">{{ customer.id }}</strong>
                                            <br>
                                            <span>{{ customer.id }} / {{ customer.costumer_name }}</span>
                                            <br>
                                            <Label :active="customer.is_active" />
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <span class="d-md-inline-block d-none">{{ customer.address_detail }}</span>
                                    </td>
                                    <td>
                                        <span class="d-md-inline-block d-none">{{ customer.customer_phone1 }}</span>
                                    </td>
                                    <td>
                                        <span class="d-md-inline-block d-none">{{ customer.customer_classification }}</span>
                                    </td>
                                    <td>
                                        <span class="d-md-inline-block d-none">{{ customer.customer_branch }}</span>
                                    </td>
                                    <td>
                                        <span class="d-md-inline-block d-none">
                                            <Label :active="customer.is_active" />
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-xs">
                                                <ul class="link-list-plain">
                                                    <li><nuxt-link :to="`/datapelanggan/detail/${customer.id}`">View</nuxt-link></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </td>
...
export default {
    ...
    methods: {
        ...
        fetch (resetPage = false) {
            ...
            this.$axios.$post('/api/v1/datapelanggan/p', filter)
                .then((response) => {
        ...
        downloadTemplate() {
        this.$axios
            .$get("/api/v1/datapelanggan/template", { responseType: "blob" })
            .then((response) => {
        ...
        exportData() {
        this.$axios
            .$get("/api/v1/datapelanggan/export", { responseType: "blob" })
            .then((response) => {
            const blob = new Blob([response]);
            saveAs(blob, "customer_export.xlsx");
            });
        },
        importData() {
        ...
        this.$axios
            .$post(`/api/v1/datapelanggan/import`, formData, headers)
            .then((data) => {
