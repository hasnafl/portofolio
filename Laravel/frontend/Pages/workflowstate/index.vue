        ...
        <div class="nk-block-head nk-block-head-sm">
            <div class="nk-block-between">
                <div class="nk-block-head-content">
                    <h3 class="nk-block-title page-title">Workflow State Master</h3>
                </div>
            </div>
        </div>
        <div class="card">
            <div class="card-inner">
                <div>
                    <div class="card-title-group align-start gx-3 mb-3">
                        ...
                        <div class="card-tools">
                            <nuxt-link to="/workflowstate/create" class="btn btn-primary btn-dim"><em class="icon ni ni-plus"></em><span>Add New Data</span></nuxt-link>
                        </div>
                    </div>
                ...
                <div>
                    <div class="card-title-group align-start gx-3 mb-3 mt-4">
                        <div class="card-title">
                            <h6 class="title">Latest Workflow State Created</h6>
                        </div>
                        <div class="card-tools">
                            <div class="drodown">
                                <a
                        ...
                        <table class="table table-tranx mt-4 is-compact">
                            <thead>
                                <tr class="tb-tnx-head">
                                    ...
                                    <th>
                                        <span class="d-md-inline-block d-none">Workflow State Name</span>
                                    </th>
                                    <th>
                            ...
                            <tbody>
                                <tr class="tb-tnx-item" v-for="(workflowstate, index) in data.data" :key="index">
                                    <td>
                                        <span class="d-md-inline-block d-none">{{ index + data.from }}</span>
                                        <div class="d-md-none d-inline-block">
                                            <strong class="text-primary">{{ workflowstate.workflow_state_name }}</strong>
                                            <br>
                                            <span>{{ workflowstate.id }} / {{ workflowstate.workflow_state_name }} ({{ workflowstate.style }})</span>
                                            <br>
                                            <Label :active="workflowstate.is_active" />
                                        </div>
                                    </td>
                                    <td>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-xs">
                                                <ul class="link-list-plain">
                                                    <li><nuxt-link :to="`/workflowstate/detail/${workflowstate.id}`">View</nuxt-link></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </td>
...
export default {
    ...
    methods: {
        ...
        fetch (resetPage = false) {
            ...
            this.$axios.$post('/api/v1/workflowstate/p', filter)
                .then((response) => {
